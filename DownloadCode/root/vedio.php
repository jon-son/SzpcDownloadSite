		...
		<div class="contents" align="center"></br>
			...
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="download.php">开发工具</a></li> 
   					...
   					<li><a href="vedio.php"  class="first">教学视频</a></li>
				</ul> 
			</div>		
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetVedioList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/vedio/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
					...
					mysql_query($mysql->mysqlSetCode);
					$result1=mysql_query($mysql->mysqlGetVedioList);
