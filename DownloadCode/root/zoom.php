	...
	<body>
		...
		<div class="contents" align="center"></br>
			...
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="zoom.php" class="first">讲座</a></li> 
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetLectureList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/lecture/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
			  		...
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="down_set">
                            ...
                            <a href="review.php?state=delete&tablename=activity&id=<?="$row[id]"?>" ><button class="review"> 删除 </button></a>
                        </div></br></br>
