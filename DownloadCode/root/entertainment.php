...
<html lang="en">
	...
	<body>
		...
		<div class="contents" align="center"></br>
		    ...
		    <form action="search.php?tablename=activity" method="post" class="search">
                <input type="search" autocomplete="off" placeholder="输入关键字"  name="search" required>
            </form>
            
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="zoom.php">讲座</a></li>
   					<li><a href="competition.php">竞赛</a></li> 
   					<li><a href="elective.php">选修课</a></li> 
   					<li><a href="entertainment.php" class="first">娱乐</a></li> 
				</ul> 
			</div>		
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetEntertainmentList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/entertainment/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
                        ...
                        <div class="down_set">
                            ...
                            <a href="review.php?state=success&tablename=activity&id=<?="$row[id]"?>" ><button class="review"> 审核通过 </button></a>
                            <a href="review.php?state=failed&tablename=activity&id=<?="$row[id]"?>" ><button class="review"> 审核失败 </button></a>
                        </div></br></br>
			  		...
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="down_set">
                            <a><input type="button" class="download" value="活动详情" onclick="detail('<?="$row[abstract]"?>')"></input></a></br></br>
                            <a href="review.php?state=cancel&tablename=activity&id=<?="$row[id]"?>" ><button class="review"> 下架 </button></a>
                            <a href="review.php?state=detele&tablename=activity&id=<?="$row[id]"?>" ><button class="review"> 删除 </button></a>
                        </div></br></br>
