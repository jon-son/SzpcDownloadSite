	...
	<body>
		...
		<div class="contents" align="center"></br>
			...
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="download.php" class="first">开发工具</a></li> 
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetIdeList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/ide/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
					...
					mysql_query($mysql->mysqlSetCode);
					$result1=mysql_query($mysql->mysqlGetIdeList);
