		...
		<div class="contents" align="center"></br>
			...
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="download.php">开发工具</a></li> 
   					<li><a href="environmental.php" class="first">开发环境</a></li> 
   					<li><a href="gho.php">系统镜像</a></li> 
   					<li><a href="software.php">常用软件</a></li> 
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetDevList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/devlop_environment/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
					...
					mysql_query($mysql->mysqlSetCode);
					$result1=mysql_query($mysql->mysqlGetDevList);
