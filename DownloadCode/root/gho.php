		...
		<div class="contents" align="center"></br>
			...
			<div class="classification">
	 			<ul id="nav"> 
    				<li><a href="download.php">开发工具</a></li> 
   					...
   					<li><a href="gho.php"  class="first">系统镜像</a></li> 
			...
			<div class="hot_download">
                ...
                <?php
					...
					$result=mysql_query($mysql->mysqlGetGhoList);
			  		while($row=mysql_fetch_assoc($result))
                    {
                        ...
                        <div class="img_set">
                            <img class="img" src="../img/gho/<?="$row[img]"?>" />
                        </div>
                        <div class="name_set">
					...
					mysql_query($mysql->mysqlSetCode);
					$result1=mysql_query($mysql->mysqlGetGhoList);
